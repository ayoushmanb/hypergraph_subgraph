source("./support_functions/sim-type3-triangle-supp.R")
...
sub.MC.rep <- 200 # 1000 # MC iteration for subsampling
...
set.seed(1234)
type3.triangle.true <- unlist(pbmclapply(1:MC.rep, function(rep){
  get.val1(n,m,n.prob, exponent,apx_itr, 1)
}, mc.cores =  n.core, mc.set.seed = F, mc.style = "ETA"))

# Subsampling ==================================================================

type3.triangle.sub <- pbmclapply(1:sub.MC.rep, function(sub_rep){
...
type3.triangle.sub.ci(type3.triangle.true, type3.triangle.sub,
