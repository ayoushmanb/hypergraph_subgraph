source("./support_functions/sim-type2-clustering-coeff-supp.R")
...
set.seed(1234)
type2.clus.true <- unlist(pbmclapply(1:MC.rep, function(rep){
  get.val1(n,m,n.prob, exponent, apx_itr, 1)
}, mc.cores =  n.core, mc.set.seed = F, mc.style = "ETA"))

# Subsampling ==================================================================

type2.clus.sub <- pbmclapply(1:sub.MC.rep, function(sub_rep){
...
type2.clus.coeff.sub.ci(type2.clus.true, type2.clus.sub,
